    ...
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 1, width: "100%", maxWidth: 400, padding: "0 24px" }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          <div style={{ fontSize: 11, letterSpacing: 4, color: "#d4af7b", textTransform: "uppercase", marginBottom: 16 }}>
            Sekreter
          </div>
          <div style={{ fontSize: 32, fontWeight: 700, color: "#fff", marginBottom: 8 }}>Kariyer Koçu</div>
          <div style={{ fontSize: 14, color: "#6a5a40", fontStyle: "italic" }}>Giriş yap</div>
        </div>
...
export default function App() {
  ...
  return <BurcuDashboard onLogout={() => supabase.auth.signOut()} />;
}

// =============================================
// MAIN COMPONENT
// =============================================
function BurcuDashboard({ onLogout }) {
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8 }}>
              <div style={{ display: "flex", gap: 8 }}>
                <button onClick={() => window.location.href = "https://dashboard-chi-woad-48.vercel.app"} style={{
                  background: "transparent", border: "1px solid rgba(201,169,97,0.2)",
                  borderRadius: 8, padding: "5px 12px", color: "#c9a961",
                  fontSize: 11, cursor: "pointer", fontFamily: "inherit",
                }}>← Ana Ekran</button>
                <button onClick={onLogout} style={{
                  background: "transparent", border: "1px solid rgba(245,235,215,0.08)",
                  borderRadius: 8, padding: "5px 12px", color: "#6a5a40",
                  fontSize: 11, cursor: "pointer", fontFamily: "inherit",
                }}>Çıkış Yap</button>
              </div>
              <div style={{
                ...
                textAlign: "center", border: "1px solid rgba(245,235,215,0.12)",
              }}>
